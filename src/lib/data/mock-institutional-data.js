export const INSTANT_INSTITUTIONAL_DATA = {
    nvda: {
...
export function getFallbackOrGenerateReport(query, horizon = '1-3y') {
    const clean = query.toLowerCase().trim();
    if (clean === 'nvda' || clean === 'nvidia' || clean === 'nvidia corp' || clean === 'nvidia corporation')
        return INSTANT_INSTITUTIONAL_DATA.nvda;
    if (clean === 'zomato' || clean === 'zomato ltd' || clean === 'blinkit')
        return INSTANT_INSTITUTIONAL_DATA.zomato;
    if (clean === 'aapl' || clean === 'apple' || clean === 'apple inc')
        return INSTANT_INSTITUTIONAL_DATA.aapl;
