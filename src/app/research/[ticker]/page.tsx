...
export default function ResearchDashboardPage() {
  ...
  const [clientTicker, setClientTicker] = useState<string>('');
  ...
  const horizon = (searchParams?.get('horizon') as InvestmentHorizon) || '1-3y';
  ...
  useEffect(() => {
    let isMounted = true;
    if (!rawTicker || rawTicker === 'Target Company') return;
            ...
            >
              ...
              <div className="glass-card p-4 rounded-2xl border border-white/10 text-xs text-slate-400 flex items-center justify-between">
                ...
                <button
                  ...
                  className="underline hover:text-white transition-colors font-semibold text-indigo-400"
                >
