...
import { BarChart3, PieChart, Table as TableIcon, TrendingUp, ShieldCheck, DollarSign } from 'lucide-react';
...
export function FinancialCharts({ report }: FinancialChartsProps) {
  const [activeTab, setActiveTab] = useState<'projections' | 'radar' | 'dcf'>('projections');
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3 px-4 text-right font-sans">
                        {row.upsidePct > 15 ? (
                          <span className="px-2 py-0.5 rounded bg-emerald-500/20 text-emerald-300 text-[10px] font-bold">Undervalued</span>
                        ) : row.upsidePct < -5 ? (
                          <span className="px-2 py-0.5 rounded bg-rose-500/20 text-rose-300 text-[10px] font-bold">Overvalued</span>
                        ) : (
                          <span className="px-2 py-0.5 rounded bg-amber-500/20 text-amber-300 text-[10px] font-bold">Fairly Valued</span>
                        )}
                      </td>
                    </tr>
                  );
